        ...
        <div className='aboutUsPosition'>
            <div className="aboutUsContainer">
                <div className='aboutUsSetOfTwo'>
                    <img src={giphy1} data-aos="zoom-in" data-aos-duration="2000" width="150px" height="200px" className='aboutUsImg' />
                    <h2 className='aboutUsH2'>
                        DEAR FRIEND, <br/>
                        Welcome to our e-gallery of emotions.<br />
                        Take a look at the art, put the cursor on the image to see the additional meaning.
                    </h2>
                </div>
                <div className='aboutUsSetOfTwo'>
                    <h2 className='aboutUsH2'>
                    ...
                    <img src={giphy2} data-aos="zoom-in" data-aos-delay="300" data-aos-duration="2000" width="250px" className='aboutUsImg imgTwo' />
                </div>
                <div className='aboutUsSetOfTwo'>
                    <img src={giphy3} data-aos="zoom-in" data-aos-delay="600" data-aos-duration="2000" width="150px" height="200px" className='aboutUsImg' />
                    <h2 className='aboutUsH2'>
                        PHYSICAL! <br/>
